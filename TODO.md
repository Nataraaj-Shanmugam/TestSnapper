...
**Parallel schedule:** Groups A, B, C, D, E-1…E-3, E-5, E-6 are fully independent.
**Sequential dependency:** E-4 (recorder-utils tests) requires B-1 to land first.
...
- [ ] 🟡 **A-1 Version single source of truth.**
...
- [ ] 🔵 **A-2 Fix `homepage_url` placeholder.**
...
- [ ] 🔵 **A-4 Expose `Logger` to content scripts.**
...
- [ ] 🟠 **B-1 Extract testable logic to `src/core/recorder-utils.js`.**
...
- [ ] 🟠 **B-2 Wire `Logger` into `background.js`.**
...
- [ ] 🟠 **B-3 Screenshot privacy JSDoc note.**
...
- [ ] 🔵 **B-4 `setUninstallURL` disclosure comment.**
...
- [ ] 🔵 **B-5 Comment archaeology in `background.js`.**
...
- [ ] 🟠 **C-1 Wire `Logger` into all core modules.**
...
- [ ] 🟠 **C-2 Document `FSStorageManager` Proxy routing contract.**
...
- [ ] 🔵 **C-3 Comment archaeology in core files.**
...
- [ ] 🟠 **D-1 Wire `Logger` into content scripts.**
...
- [ ] 🔵 **D-2 `prefers-color-scheme` initial theme.**
...
- [ ] 🔵 **D-3 Comment archaeology in content scripts.**
...
- [ ] 🔵 **E-4 `recorder-utils` tests** *(depends on B-1).*
...
- [ ] 🟡 **E-6 `FSStorageManager` Proxy fall-through tests.**
...
- [ ] 🔵 **E-5 Deduplicate `CompressionStream` polyfill.**
